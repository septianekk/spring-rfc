package com.spring.api_rfc.spring_rfc.handler;


import com.spring.api_rfc.spring_rfc.config.FlagConfig;
import com.spring.api_rfc.spring_rfc.util.LoggingFile;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public GlobalExceptionHandler() { strExceptionArr [0] = "GlobalExceptionHandler";}
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
        ...
        LoggingFile.exceptionStringz(strExceptionArr, ex, FlagConfig.getFlagLogging());
